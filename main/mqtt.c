...
/* Global MQTT client handle (used elsewhere if needed) */
...
/* MQTT property data moved here from header (internal linkage) */
...
void mqtt5_app_start(void)
{
    ...
    /* Initialize global client handle so other modules can reference it */
